...
public class Messages {
	...
	public static final String INVALID_PARAMATER_TYPE = "Invalid parameter type";
	...
	public static final String RECORD_WRITE_ERROR = "An error ocurred on writing record to '%s'"
			.formatted(RECORD_FILENAME);

	public static final String RECORD_READ_ERROR = "An error ocurred on reading record from '%s'"
			.formatted(RECORD_FILENAME);
	...
	public static final String ZOMBIE_NAME_SHORTCUT = "[Z]ombie";
	...
	public static final String EXPLOSIVE_CHERRY_BOMB_SYMBOL = "C";
